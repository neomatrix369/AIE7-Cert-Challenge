...
def get_vectorstore_after_loading_students_loan_data_into_qdrant():
    ...
    logger.info(f"text_splitter: Chunk Size: {text_splitter.chunk_size} | Chunk Overlap: {text_splitter.chunk_overlap}")
...
logger.info(f"child_splitter: Chunk Size: {child_splitter.chunk_size} | Chunk Overlap: {child_splitter.chunk_overlap}")
