    ...
    def parse(self, text: str) -> dict:
        ...
        return {
            ...
            "summary": {
                ...
                "nodes": list(set([t.get("node") for t in tool_calls if t.get("node")]))
            }
        }
...
def _extract_contexts_from_tool_result(tool_name: str, content: str) -> list:
    ...
    if tool_name == 'tavily_search_results_json':
        ...
        if content and len(content.strip()) > 20:
            ...
            meaningful_chunks = [chunk.strip() for chunk in chunks if len(chunk.strip()) > 30]
    ...
    for paper in papers[1:]:  # Skip first empty split
        ...
        for line in lines:
            if line.startswith('Title:'):
                ...
                summary_parts.append(summary_text[:500] + '...' if len(summary_text) > 500 else summary_text)
                break
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("No paste.txt file found. Use parse_logs(your_text) to parse any log text.")
